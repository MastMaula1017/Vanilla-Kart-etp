...
const About = () => {
    return (
        <div className="space-y-16 pb-12 dark:bg-gray-950 transition-colors duration-300">
            {/* 1. Hero Section */}
            <section className="relative overflow-hidden pt-12 pb-12 px-6 text-center lg:pt-20">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="inline-flex items-center rounded-full bg-indigo-50 px-3 py-1 text-xs font-medium text-indigo-600 mb-6 border border-indigo-100 dark:bg-indigo-900/30 dark:text-indigo-300 dark:border-indigo-800">
                        <Sparkles size={12} className="mr-2" />
                        About ConsultPro
                    </div>
                    <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-5xl mb-6 dark:text-white">
                    ...
                    <p className="text-lg text-gray-600 mb-8 leading-relaxed dark:text-gray-300 max-w-2xl mx-auto">
            ...
            <section className="px-4 container mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="relative">
                        ...
                        <div className="relative overflow-hidden rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
                            <img
                    ...
                    <div>
                        ...
                        <p className="text-base text-gray-600 mb-4 leading-relaxed dark:text-gray-300">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {[
                                ...
                                <div key={i} className="flex items-center space-x-3 p-2.5 rounded-lg bg-gray-50 border border-gray-100 dark:bg-gray-900 dark:border-gray-800">
            ...
            <section className="px-4 container mx-auto">
                <div className="text-center mb-10">
                    <h2 className="text-2xl font-bold text-gray-900 mb-2 dark:text-white">Our Core Values</h2>
                    <p className="text-gray-600 max-w-2xl mx-auto dark:text-gray-300 text-sm">Built on trust, transparency, and excellence. These principles guide everything we do.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <SpotlightCard
                            key={index}
                            className="p-6 h-full flex flex-col items-center text-center dark:bg-gray-900"
                            spotlightColor="rgba(99, 102, 241, 0.15)"
                        >
                            <div className={`w-12 h-12 rounded-xl ${value.bg} ${value.color} flex items-center justify-center mb-4`}>
                                <value.icon size={24} />
                            </div>
                            <h3 className="text-lg font-bold text-gray-900 mb-3 dark:text-white">{value.title}</h3>
            ...
            <section className="relative px-4 pb-12">
                <div className="container mx-auto">
                    <div className="relative overflow-hidden rounded-2xl bg-indigo-900 px-6 py-12 text-center shadow-2xl md:px-12">
                        <div className="absolute inset-0 bg-gradient-to-br from-indigo-800 to-gray-900"></div>

                        <div className="relative z-10 max-w-2xl mx-auto">
                            <h2 className="text-2xl font-bold tracking-tight text-white mb-4 md:text-3xl">
                                Part of the Revolution?
                            </h2>
                            <p className="text-base text-indigo-200 mb-8">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-4">
                                <Link
                                    to="/register"
                                    className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-base font-bold text-indigo-900 transition-all hover:bg-yellow-50 hover:scale-105 shadow-lg"
                                >
                                    Get Started
                                ...
                                <Link
                                    to="/contact"
                                    className="inline-flex items-center justify-center rounded-full bg-transparent border-2 border-indigo-300 px-6 py-3 text-base font-bold text-white transition-all hover:bg-white/10"
                                >
                                    Contact Us
                                </Link>
                            </div>
